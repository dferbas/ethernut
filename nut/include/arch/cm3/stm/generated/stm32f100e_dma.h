/* Do not edit! Generated automatically from /devel/cubemx/db/mcu/IP/DMA-STM32F100E_dma_v1_0_Modes.xml.*/

#if !defined(_STM32F100E_DMA_H_)
# define _STM32F100E_DMA_H_

#define STM32_DMA_VERSION 10

#define DMA_ADC1           {{DMA1_Channel1_BASE, &sig_DMA1_CH1  , DMA_IRQ_SINGLE}, {}}
#define DMA_DAC_CH1        {{DMA1_Channel3_BASE, &sig_DMA1_CH3  , DMA_IRQ_SINGLE},\
                            {DMA2_Channel3_BASE, &sig_DMA2_CH3  , DMA_IRQ_SINGLE}, {}}
#define DMA_DAC_CH2        {{DMA1_Channel4_BASE, &sig_DMA1_CH4  , DMA_IRQ_SINGLE},\
                            {DMA2_Channel4_BASE, &sig_DMA_GROUP1, DMA_IRQ_GROUP }, {}}
...
#define DMA_TIM15_CH1      {{DMA1_Channel5_BASE, &sig_DMA1_CH5  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM15_COM      {{DMA1_Channel5_BASE, &sig_DMA1_CH5  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM15_TRIG     {{DMA1_Channel5_BASE, &sig_DMA1_CH5  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM15_UP       {{DMA1_Channel5_BASE, &sig_DMA1_CH5  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM16_CH1      {{DMA1_Channel6_BASE, &sig_DMA1_CH6  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM16_UP       {{DMA1_Channel6_BASE, &sig_DMA1_CH6  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM17_CH1      {{DMA1_Channel7_BASE, &sig_DMA1_CH7  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM17_UP       {{DMA1_Channel7_BASE, &sig_DMA1_CH7  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM1_CH1       {{DMA1_Channel2_BASE, &sig_DMA1_CH2  , DMA_IRQ_SINGLE},\
                            {DMA1_Channel6_BASE, &sig_DMA1_CH6  , DMA_IRQ_SINGLE}, {}}
...
#define DMA_TIM6_UP        {{DMA1_Channel3_BASE, &sig_DMA1_CH3  , DMA_IRQ_SINGLE},\
                            {DMA2_Channel3_BASE, &sig_DMA2_CH3  , DMA_IRQ_SINGLE}, {}}
#define DMA_TIM7_UP        {{DMA1_Channel4_BASE, &sig_DMA1_CH4  , DMA_IRQ_SINGLE},\
                            {DMA2_Channel4_BASE, &sig_DMA_GROUP1, DMA_IRQ_GROUP }, {}}
...
#define DMA_UART5_RX       {{DMA2_Channel4_BASE, &sig_DMA_GROUP1, DMA_IRQ_GROUP }, {}}
#define DMA_UART5_TX       {{DMA2_Channel1_BASE, &sig_DMA2_CH1  , DMA_IRQ_SINGLE}, {}}
