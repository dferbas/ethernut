/* Do not edit!
 * Generated from /devel/cubemx/db/mcu/IPGPIO-STM32F031_gpio_v1_0_Modes.xml*/

#if !defined(_STM32F031_PINMUX_H_)
# define _STM32F031_PINMUX_H_

#define EVENTOUT_FUNC            0
#define HDMI_CEC_CEC_FUNC        1
#define I2C1_SCL_FUNC            2
#define I2C1_SDA_FUNC            3
#define I2C1_SMBA_FUNC           4
#define I2C2_SCL_FUNC            5
#define I2C2_SDA_FUNC            6
#define I2S1_CK_FUNC             7
#define I2S1_MCK_FUNC            8
#define I2S1_SD_FUNC             9
#define I2S1_WS_FUNC             10
#define IR_OUT_FUNC              11
#define RCC_MCO_FUNC             12
#define RTC_REFIN_FUNC           13
#define RTC_TAMP2_FUNC           14
#define SPI1_MISO_FUNC           15
#define SPI1_MOSI_FUNC           16
#define SPI1_NSS_FUNC            17
#define SPI1_SCK_FUNC            18
#define SPI2_MISO_FUNC           19
#define SPI2_MOSI_FUNC           20
#define SPI2_NSS_FUNC            21
#define SPI2_SCK_FUNC            22
#define SYS_SWCLK_FUNC           23
#define SYS_WKUP1_FUNC           24
#define TIM14_CH1_FUNC           25
#define TIM15_BKIN_FUNC          26
#define TIM15_CH1_FUNC           27
#define TIM15_CH1N_FUNC          28
#define TIM15_CH2_FUNC           29
#define TIM16_BKIN_FUNC          30
#define TIM16_CH1_FUNC           31
#define TIM16_CH1N_FUNC          32
#define TIM17_BKIN_FUNC          33
#define TIM17_CH1_FUNC           34
#define TIM17_CH1N_FUNC          35
#define TIM1_BKIN_FUNC           36
#define TIM1_CH1_FUNC            37
#define TIM1_CH1N_FUNC           38
#define TIM1_CH2_FUNC            39
#define TIM1_CH2N_FUNC           40
#define TIM1_CH3_FUNC            41
#define TIM1_CH3N_FUNC           42
#define TIM1_CH4_FUNC            43
#define TIM1_ETR_FUNC            44
#define TIM2_CH1_FUNC            45
#define TIM2_CH2_FUNC            46
#define TIM2_CH3_FUNC            47
#define TIM2_CH4_FUNC            48
#define TIM2_ETR_FUNC            49
#define TIM3_CH1_FUNC            50
#define TIM3_CH2_FUNC            51
#define TIM3_CH3_FUNC            52
#define TIM3_CH4_FUNC            53
#define TSC_G1_IO1_FUNC          54
#define TSC_G1_IO2_FUNC          55
#define TSC_G1_IO3_FUNC          56
#define TSC_G1_IO4_FUNC          57
#define TSC_G2_IO1_FUNC          58
#define TSC_G2_IO2_FUNC          59
#define TSC_G2_IO3_FUNC          60
#define TSC_G2_IO4_FUNC          61
#define TSC_G3_IO2_FUNC          62
#define TSC_G3_IO3_FUNC          63
#define TSC_G3_IO4_FUNC          64
#define TSC_G4_IO1_FUNC          65
#define TSC_G4_IO2_FUNC          66
#define TSC_G4_IO3_FUNC          67
#define TSC_G4_IO4_FUNC          68
#define TSC_G5_IO1_FUNC          69
#define TSC_G5_IO2_FUNC          70
#define TSC_G5_IO3_FUNC          71
#define TSC_G5_IO4_FUNC          72
#define TSC_G6_IO1_FUNC          73
#define TSC_G6_IO2_FUNC          74
#define TSC_G6_IO3_FUNC          75
#define TSC_G6_IO4_FUNC          76
#define TSC_SYNC_FUNC            77
#define USART1_CK_FUNC           78
#define UART1_CK_FUNC            78
#define USART1_CTS_FUNC          79
#define UART1_CTS_FUNC           79
#define USART1_DE_FUNC           80
#define UART1_DE_FUNC            80
...
#define USART2_RTS_FUNC          87
#define UART2_RTS_FUNC           87
#define USART2_RX_FUNC           88
#define UART2_RX_FUNC            88
#define USART2_TX_FUNC           89
#define UART2_TX_FUNC            89

# define PINMUX(gpio, func) ((gpio == PIN_NONE) ? AF_PIN_NONE : 	\
	((gpio == PA00) && (func == RTC_TAMP2_FUNC           )) ?  0 : \
	((gpio == PA00) && (func == SYS_WKUP1_FUNC           )) ?  0 : \
	((gpio == PA00) && (func == USART1_CTS_FUNC          )) ?  1 : \
	...
	((gpio == PA01) && (func == USART1_DE_FUNC           )) ?  1 : \
	((gpio == PA01) && (func == USART1_RTS_FUNC          )) ?  1 : \
	...
	((gpio == PA02) && (func == USART1_TX_FUNC           )) ?  1 : \
	...
	((gpio == PA03) && (func == USART1_RX_FUNC           )) ?  1 : \
	...
	((gpio == PA04) && (func == USART1_CK_FUNC           )) ?  1 : \
	...
	((gpio == PA05) && (func == HDMI_CEC_CEC_FUNC        )) ?  1 : \
	...
	((gpio == PB08) && (func == HDMI_CEC_CEC_FUNC        )) ?  2 : \
	...
	((gpio == PB10) && (func == HDMI_CEC_CEC_FUNC        )) ?  2 : \
	...
	((gpio == PB12) && (func == SPI1_NSS_FUNC            )) ?  0 : \
	...
	((gpio == PB15) && (func == SPI1_MOSI_FUNC           )) ?  0 : \
