/* Do not edit!
 * Generated from /devel/cubemx/db/mcu/IPGPIO-STM32L031_gpio_v1_0_Modes.xml*/

#if !defined(_STM32L031_PINMUX_H_)
# define _STM32L031_PINMUX_H_
...
#define RTC_OUT_ALARM_FUNC       16
#define RTC_OUT_CALIB_FUNC       17
#define RTC_REFIN_FUNC           18
#define SPI1_MISO_FUNC           19
#define SPI1_MOSI_FUNC           20
#define SPI1_NSS_FUNC            21
#define SPI1_SCK_FUNC            22
#define SYS_SWCLK_FUNC           23
#define SYS_SWDIO_FUNC           24
#define TIM21_CH1_FUNC           25
#define TIM21_CH2_FUNC           26
#define TIM21_ETR_FUNC           27
#define TIM22_CH1_FUNC           28
#define TIM22_CH2_FUNC           29
#define TIM22_ETR_FUNC           30
#define TIM2_CH1_FUNC            31
#define TIM2_CH2_FUNC            32
#define TIM2_CH3_FUNC            33
#define TIM2_CH4_FUNC            34
#define TIM2_ETR_FUNC            35
#define USART2_CK_FUNC           36
#define UART2_CK_FUNC            36
#define USART2_CTS_FUNC          37
#define UART2_CTS_FUNC           37
#define USART2_DE_FUNC           38
#define UART2_DE_FUNC            38
#define USART2_RTS_FUNC          39
#define UART2_RTS_FUNC           39
#define USART2_RX_FUNC           40
#define UART2_RX_FUNC            40
#define USART2_TX_FUNC           41
#define UART2_TX_FUNC            41
...
# define PINMUX(gpio, func) ((gpio == PIN_NONE) ? AF_PIN_NONE : 	\
	...
	((gpio == PA04) && (func == TIM22_ETR_FUNC           )) ?  5 : \
	...
	((gpio == PA06) && (func == TIM22_CH1_FUNC           )) ?  5 : \
	...
	((gpio == PA07) && (func == TIM22_CH2_FUNC           )) ?  5 : \
	...
	((gpio == PA09) && (func == TIM22_CH1_FUNC           )) ?  5 : \
	((gpio == PA10) && (func == I2C1_SDA_FUNC            )) ?  1 : \
	((gpio == PA10) && (func == USART2_RX_FUNC           )) ?  4 : \
	((gpio == PA10) && (func == TIM22_CH2_FUNC           )) ?  5 : \
	...
	((gpio == PB09) && (func == EVENTOUT_FUNC            )) ?  2 : \
	((gpio == PB09) && (func == I2C1_SDA_FUNC            )) ?  4 : \
	((gpio == PB10) && (func == TIM2_CH3_FUNC            )) ?  2 : \
	((gpio == PB10) && (func == LPUART1_TX_FUNC          )) ?  6 : \
	((gpio == PB11) && (func == EVENTOUT_FUNC            )) ?  0 : \
	((gpio == PB11) && (func == TIM2_CH4_FUNC            )) ?  2 : \
	((gpio == PB11) && (func == LPUART1_RX_FUNC          )) ?  6 : \
	((gpio == PB12) && (func == SPI1_NSS_FUNC            )) ?  0 : \
	((gpio == PB12) && (func == EVENTOUT_FUNC            )) ?  6 : \
	((gpio == PB13) && (func == SPI1_SCK_FUNC            )) ?  0 : \
	((gpio == PB13) && (func == RCC_MCO_FUNC             )) ?  2 : \
	((gpio == PB13) && (func == TIM21_CH1_FUNC           )) ?  5 : \
	((gpio == PB13) && (func == LPUART1_CTS_FUNC         )) ?  6 : \
	((gpio == PB14) && (func == SPI1_MISO_FUNC           )) ?  0 : \
	((gpio == PB14) && (func == RTC_OUT_ALARM_FUNC       )) ?  2 : \
	((gpio == PB14) && (func == RTC_OUT_CALIB_FUNC       )) ?  2 : \
	((gpio == PB14) && (func == TIM21_CH2_FUNC           )) ?  5 : \
	((gpio == PB14) && (func == LPUART1_DE_FUNC          )) ?  6 : \
	((gpio == PB14) && (func == LPUART1_RTS_FUNC         )) ?  6 : \
	((gpio == PB15) && (func == SPI1_MOSI_FUNC           )) ?  0 : \
	((gpio == PB15) && (func == RTC_REFIN_FUNC           )) ?  2 : \
	((gpio == PC00) && (func == LPTIM1_IN1_FUNC          )) ?  0 : \
	((gpio == PC00) && (func == EVENTOUT_FUNC            )) ?  2 : \
	((gpio == PC00) && (func == LPUART1_RX_FUNC          )) ?  6 : \
	AF_NO_SUCH_PINFUNC)
...
# define TIMERMUX(gpio, timer_nr, channel_nr) ((gpio == PIN_NONE) ? AF_PIN_NONE : 	\
	...
	((gpio == PA06) && (timer_nr == 22) && (channel_nr ==  1)) ?  5 : \
	((gpio == PA07) && (timer_nr == 22) && (channel_nr ==  2)) ?  5 : \
	((gpio == PA08) && (timer_nr ==  2) && (channel_nr ==  1)) ?  5 : \
	((gpio == PA09) && (timer_nr == 22) && (channel_nr ==  1)) ?  5 : \
	((gpio == PA10) && (timer_nr == 22) && (channel_nr ==  2)) ?  5 : \
	...
	((gpio == PB04) && (timer_nr == 22) && (channel_nr ==  1)) ?  4 : \
	((gpio == PB05) && (timer_nr == 22) && (channel_nr ==  2)) ?  4 : \
	((gpio == PB06) && (timer_nr == 21) && (channel_nr ==  1)) ?  5 : \
	((gpio == PB10) && (timer_nr ==  2) && (channel_nr ==  3)) ?  2 : \
	((gpio == PB11) && (timer_nr ==  2) && (channel_nr ==  4)) ?  2 : \
	((gpio == PB13) && (timer_nr == 21) && (channel_nr ==  1)) ?  5 : \
	((gpio == PB14) && (timer_nr == 21) && (channel_nr ==  2)) ?  5 : \
	AF_NO_SUCH_PINFUNC)
#endif
