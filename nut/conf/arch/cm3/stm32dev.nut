...
--        sources = { "cm3/dev/stm/stm32_sdio.c" },
    ...
    -- STM32 Signal handler
    {
        ...
        options =
        {
            ...
            {
                macro = "HW_UART9_STM32",
                brief = "UART9 Availability",
                description = "UART8 Availability",
                requires = { "HW_UART9_STM32" },
                default = "1",
                type = "integer",
                file = "include/cfg/devices.h"
            },
            {
                macro = "HW_UART10_STM32",
                brief = "UART10 Availability",
                description = "UART10 Availability",
                requires = { "HW_UART10_STM32" },
                default = "1",
                type = "integer",
                file = "include/cfg/devices.h"
            },
